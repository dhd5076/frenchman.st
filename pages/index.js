        ...
        <div className="h-auto w-full shadow-black">
            <div className={`transition-all pt-16 duration-1000 bg-black/75`}>
                ...
                <div className="text-white w-full -mt-32 pb-16 text-center relative bottom-0 bg-gradient-to-b from-black/0 to-black/25">
                    <span className={`rounded-full transition-all duration-1000 border-2 p-4 fas fa-chevron-down bg-white/25 animate-bounce`} onClick={() => { scrollToElementById("first"); setShowScroll(false) }}></span>
                </div>
            </div>
            ...
            <div className="p-6 font-sans bg-highlight rosewood-font min-h-[100vh] pt-36" id="menu">
